<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ScanIn_Register.aspx.vb" Inherits="Intrack.ScanIn_Register" %>
...
<body  class="hold-transition skin-blue-light sidebar-mini">
    ...
    <table class="style2" align="center" border="2">
        ...
        <tr>
            <td clas s="style6" colspan="2" align="center">
                <asp:Button ID="BtnProcess" runat="server" Text="Process" 
                    PostBackUrl="~/ScanIn_Register.aspx" />
            </td>
        </tr>
    </table>
    </form>
