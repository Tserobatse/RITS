<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="View_Assets.aspx.vb" Inherits="Intrack.View_Assets" %>
...
<body  class="hold-transition skin-blue-light sidebar-mini">
    ...
    <div>
     <asp:Label ID="Label2" runat="server" BackColor="White" 
            Text="Assets:" BorderColor="#CCCCCC" Font-Bold="True" 
                    Font-Italic="True" ForeColor="#666666"></asp:Label>
                    </div>
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AllowSorting="True" AutoGenerateColumns="False" CellPadding="3" 
        DataSourceID="SqlDataSource1" 
        EmptyDataText="There are no data records to display." Font-Size="X-Small" PageSize="20" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
        <Columns>
            ...
            <asp:BoundField DataField="AWARDSUP_TEL" HeaderText="TE NO." 
            ...
            <asp:BoundField DataField="Asset_CheckIn_Date" HeaderText="Asset_CheckIn_Date" 
                SortExpression="Asset_CheckIn_Date" />
            <asp:BoundField DataField="Asset_CheckOut_Date" 
                HeaderText="Asset_CheckOut_Date" SortExpression="Asset_CheckOut_Date" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="spGet_Req_Assets" SelectCommandType="StoredProcedure">
    </asp:SqlDataSource>
    </form>
