<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AllUsersReport.aspx.vb" Inherits="Intrack.AllUsersReport" %>

<%@ Register src="Controls/Reg_Header.ascx" tagname="Registry_Hd" tagprefix="rov" %>
<%@ Register src="Controls/All_User_Navbar.ascx" tagname="All_User_Nb" tagprefix="rov" %>
...
<body  class="hold-transition skin-blue-light sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <rov:Registry_Hd ID="User_Hd" runat="server" />
        <rov:All_User_Nb ID="User_Nb" runat="server" />
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AllowSorting="True" CellPadding="3" DataKeyNames="REQ_ID" 
        DataSourceID="SqlDataSource1" 
        EmptyDataText="There are no data records to display." Font-Size="X-Small" style="margin-top: 15px" Width="77%" 
        HorizontalAlign="Left" Caption="Reports" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="REQ_ID" 
                DataNavigateUrlFormatString="View_RegistryCF01Details.aspx?REQ_ID={0}" 
        ...
        SelectCommand="spGetAllUserReport" SelectCommandType="StoredProcedure">
        <SelectParameters>
            ...
            <asp:FormParameter DefaultValue="01/01/2012" FormField="txtStartDate" 
                Name="StartDate" Type="DateTime" />
            <asp:FormParameter DefaultValue="01/01/2015" FormField="txtEnddate" 
          ...
          <!-- /.content-wrapper -->
                ...
                <rov:Registry_Ft ID="User_Ft" runat="server" />
