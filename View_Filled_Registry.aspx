<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="View_Filled_Registry.aspx.vb" Inherits="Intrack.View_Filled_Registry" %>
...
<body  class="hold-transition skin-blue-light sidebar-mini">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        HorizontalAlign="Left" PageSize="20" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="DESCRIPTION_SERVICE" HeaderText="SERVICES" 
            ...
            <asp:BoundField DataField="REQUESTER_TEL" HeaderText="REQUESTER TEL" 
                SortExpression="REQUESTER_TEL" />
            <asp:BoundField DataField="Progress_Description" 
                HeaderText="Progress Description" SortExpression="Progress_Description" />
            ...
            <asp:BoundField DataField="Assets" HeaderText="Assets" 
                SortExpression="Assets" />
            <asp:BoundField DataField="FillNo" HeaderText="FillNo" SortExpression="FillNo">
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Req_ID" 
                DataNavigateUrlFormatString="PrintFillingInfomation.aspx?Req_ID={0}" 
                HeaderText="Print" NavigateUrl="~/PrintFillingInfomation.aspx" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="spGet_Req_Registry_Paid" SelectCommandType="StoredProcedure">
        <SelectParameters>
