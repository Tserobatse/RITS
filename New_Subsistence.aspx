<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="New_Subsistence.aspx.vb" Inherits="Intrack.New_Subsistence" %>
		...
		<table border="2" class="style6" width="1000px">
			...
			<tr>
				...
				<td align="center" class="style78">
					<asp:TextBox ID="txtSuppName2" runat="server" Enabled="False" Height="20px" 
						Width="100px"></asp:TextBox>
				</td>
				<td align="center" class="style77">
					<asp:TextBox ID="txtSuppName3" runat="server" Enabled="False" Height="20px" 
						Width="100px"></asp:TextBox>
				</td>
				<td align="center" class="style76">
					<asp:TextBox ID="txtSuppName4" runat="server" Enabled="False" Height="20px" 
						Width="100px"></asp:TextBox>
				</td>
				<td align="center" class="style95">
					<asp:TextBox ID="txtSuppName5" runat="server" Enabled="False" Height="20px" 
						Width="100px"></asp:TextBox>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="style18">
					<asp:TextBox ID="txtsuppAmount2" runat="server" Enabled="False" height="20px" 
						Width="100px">0.00</asp:TextBox>
				</td>
				<td class="style23">
					<asp:TextBox ID="txtsuppAmount3" runat="server" Enabled="False" height="20px" 
						Width="100px">0.00</asp:TextBox>
				</td>
				<td class="style24">
					<asp:TextBox ID="txtsuppAmount4" runat="server" Enabled="False" height="20px" 
						Width="100px">0.00</asp:TextBox>
				</td>
				<td class="style96">
					<asp:TextBox ID="txtsuppAmount5" runat="server" Enabled="False" height="20px" 
						Width="100px">0.00</asp:TextBox>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="center" class="style29" colspan="4" valign="top">
					...
					<asp:HyperLink ID="HyperLink1" runat="server" BorderColor="#66CCFF" 
						...
						NavigateUrl="~/View_Requester_Subsistence.aspx">Main Menu</asp:HyperLink>
