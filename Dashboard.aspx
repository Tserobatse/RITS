<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Dashboard.aspx.vb" Inherits="Intrack.Dashboard" %>
...
<div class="wrapper">
 ...
 <%--           <span class="pull-right-container">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> My Dashboard</a></li>   <!-- ToDo: Link back to dasboard.aspx  -->
	    ...
	    <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="View_InternalControlRegisterCF01.aspx"><i class="fa fa-circle-o"></i> View CF 01</a></li>         
            <li><a href="View_InternalControlRegisterCF02.aspx"><i class="fa fa-circle-o"></i> View CF 02</a></li>
            <li><a href="View_InternalControlRegister_Subsistence.aspx"><i class="fa fa-circle-o"></i> View Subsistence</a></li>
            <li><a href="View_InternalControlRegister_Travel.aspx"><i class="fa fa-circle-o"></i> View Travel</a></li>
          </ul>
        </li>	
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="View_InternalControlRegister_Queries.aspx"><i class="fa fa-circle-o"></i> View Queries</a></li>
            <li><a href="Resolve_Query.aspx"><i class="fa fa-circle-o"></i> Resolve Queries</a></li>
            <li><a href="Scan-in-Queries-Register.aspx"><i class="fa fa-circle-o"></i> Scan In Queries</a></li>
          </ul>
        </li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="ScanIn_Register.aspx"><i class="fa fa-circle-o"></i> Scan Requisition</a></li>
            <li><a href="ScanInRegister3.aspx"><i class="fa fa-circle-o"></i> Scan In Filling</a></li>
		  </ul>
        </li>
...
<!--         <li class="treeview">
		 ...
		 <li>
          <a href="Scan_Out_Registry1.aspx">
        ...
        <li>
          <a href="View_Filled_Registry.aspx">
            <i class="fa fa-money"></i> <span>View Paid</span>
 <!--            <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span> -->
          </a>
		        ...
		        <li>
          <a href="Search_requisition.aspx">
 ...
 <!--            <span class="pull-right-container">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="NewUser.aspx"><i class="fa fa-circle-o"></i> New User</a></li>
		...
		<li class="treeview">
          <a href="#">
            <i class="fa fa-users"></i>
            <span>Maintain System</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="MaintainCostCentre.aspx"><i class="fa fa-circle-o"></i> Maintain Cost Centre</a></li>
              <li><a href="AddNewCostCentre.aspx"><i class="fa fa-circle-o"></i> Add Cost Centre</a></li>
              <li><a href="MaintainReq_Cycle.aspx"><i class="fa fa-circle-o"></i> Maintain Cycle </a></li>

          </ul>
        </li>
        <li class="treeview">
          <a href="Scan_Out_Registry1#">
          ...
          <ul class="treeview-menu">
            <li><a href="Units_Reports.aspx"><i class="fa fa-circle-o"></i> Unit Reports</a></li>
 ...
 <%--ToCheck --%>            
            ...
            <a href="View_InternalControlRegisterCF01.aspx" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
 ...
 <%--  ToCheck --%>          
            ...
            <a href="View_InternalControlRegister_Queries.aspx" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="View_Filled_Registry.aspx" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
<%--            <div class="box-footer no-border">
  ...
  <footer class="main-footer">
    ...
    <img src="../Images/serenity-logo-w-40.png" /> <strong>Copyright &copy; 2014-2017 <a href="http://nwpg.gov.za">Depatment of Education &amp; Sport Development</a>.</strong> All rights
    reserved.
  </footer>
  <!-- Control Sidebar -->
  <!-- /.control-sidebar -->
