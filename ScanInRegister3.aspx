<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ScanInRegister3.aspx.vb" Inherits="Intrack.ScanInRegister3" %>
    ...
    <table class="style2" align="center" border="2">
        <tr>
            <td colspan="2" class="style7">
                <strong>Check In Requisition Stage 3</strong></td>
        </tr>
        <tr>
            <td class="style9">
                &nbsp;</td>
        ...
        <tr>
            <td class="style12">
                <strong style="text-align: right">Order number</strong>:</td>
            <td class="style13">
                <table class="style1">
                    <tr>
                        <td class="style57">
                            <strong>08H</strong></td>
                        <td class="style14">
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                ControlToValidate="txtorderNo2" ErrorMessage="*"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td class="style6" colspan="2">
                <asp:Button ID="BtnProcess" runat="server" Text="Process" style="width: 70px" />
            </td>
        </tr>
    </table>
    </form>
