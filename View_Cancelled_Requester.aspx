<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="View_Cancelled_Requester.aspx.vb" Inherits="Intrack.View_Cancelled_Requester" %>
...
<body  class="hold-transition skin-blue-light sidebar-mini">
    ...
    <div>
     <asp:Label ID="Label2" runat="server" BackColor="White" 
            Text="Cancelled:" BorderColor="#CCCCCC" Font-Bold="True" 
                    Font-Italic="True" ForeColor="#666666"></asp:Label>
                    </div>
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AllowSorting="True" AutoGenerateColumns="False" BorderColor="#CCCCCC" 
        BorderStyle="None" CaptionAlign="Top" CellPadding="3" DataKeyNames="REQ_ID" 
        DataSourceID="SqlDataSource1" 
        EmptyDataText="There are no data records to display." EnableSortingAndPagingCallbacks="True" 
        Font-Size="X-Small" HorizontalAlign="Left" PageSize="20" 
        ShowFooter="True" style="margin-right: 3px; margin-top: 0px;" Width="100%" BackColor="White" BorderWidth="1px">
        <Columns>
            ...
            <asp:BoundField DataField="AWARDSUP_ADDRESS" HeaderText="Address" 
                SortExpression="AWARDSUP_ADDRESS" />
            ...
            <asp:BoundField DataField="ESTIMATED_AMOUNT" HeaderText="Amount" 
                ReadOnly="True" SortExpression="ESTIMATED_AMOUNT" />
            <asp:BoundField DataField="RSurname" HeaderText="Requester" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="spGet_Requester_Cancel" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter Name="RUserID" SessionField="RuserID" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </form>
