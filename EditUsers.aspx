<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditUsers.aspx.vb" Inherits="Intrack.EditUsers" %>
    ...
    <table border="2" class="auto-style3">
        ...
        <tr>
            <td align="right" colspan="2">
                ...
                <asp:SqlDataSource ID="SqlDataSourceCostCentre" runat="server" ConnectionString="<%$ ConnectionStrings:REQ_TRACKINGConnectionString %>" SelectCommand="SELECT [CostCenterID], [ChiefDirectorate], [Directorate], [BASCode], [CostCentreCode] FROM [Tbl_CostCentre_Info]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style1">
                ...
                <asp:TextBox ID="TxtUserID" runat="server" Visible="False" Width="74px"></asp:TextBox>
            </td>
        </tr>
    </table>
    </form>
