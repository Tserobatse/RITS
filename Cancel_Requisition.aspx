<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Cancel_Requisition.aspx.vb" Inherits="Intrack.Cancel_Requisition" %>
    ...
    <table border="1" class="sty le1" width="100%">
        <tr>
            <td class="style2" colspan="2">
                <strong>Requisition cancellation Information</strong></td>
        </tr>
        <tr>
            <td class="style56">
                Scan Barcode:</td>
        ...
        <tr>
            ...
            <td class="style54">
                <asp:TextBox ID="TxtQueryReason" runat="server" Height="59px" 
