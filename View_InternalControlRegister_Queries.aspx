<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="View_InternalControlRegister_Queries.aspx.vb" Inherits="Intrack.View_InternalControlRegister_Queries_aspx" %>
...
<body  class="hold-transition skin-blue-light sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <form id="form1" runat="server">
        <asp:Label ID="Label2" runat="server" BackColor="White" 
            Text="Queries :" BorderColor="#CCCCCC" Font-Bold="True" 
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" BackColor="White" 
            PostBackUrl="~/View_InternalControlRegister_Queries.aspx.aspx" 
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        EmptyDataText="There are no data records to display." PageSize="20" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="REQ_ID" 
                DataNavigateUrlFormatString="ViewReq_Details.aspx?REQ_ID={0}" 
                DataTextField="REQ_ID" HeaderText="View" NavigateUrl="~/ViewReq_Details.aspx" />
            ...
            <asp:BoundField DataField="NoDays" HeaderText="No. Days" 
                SortExpression="NoDays" />
            <asp:BoundField DataField="QueryDetails" HeaderText="Query Details" 
                SortExpression="QueryDetails" />
            <asp:BoundField DataField="RSurname" HeaderText="Query By" 
                SortExpression="RSurname" />
            <asp:BoundField DataField="Registry Official" HeaderText="Registry Official" 
                SortExpression="Registry Official" />
            <asp:BoundField DataField="Registry Date-in" HeaderText="Registry Date-in" 
                SortExpression="Registry Date-in" />
            <asp:BoundField DataField="QueryStatus_Description" HeaderText="Query Status" 
                SortExpression="QueryStatus_Description" />
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="spGet_Req_Registry_Queries" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="0" Name="RUserID" SessionField="RusedID" 
                Type="Int32" />
            <asp:ControlParameter ControlID="TxtSearch" DefaultValue="0" Name="REQ_ID" 
