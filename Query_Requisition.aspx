<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Query_Requisition.aspx.vb" Inherits="Intrack.Query_Requisition" %>
...
<body  class="hold-transition skin-blue-light sidebar-mini">
    ...
    <table border="1" class="sty le1" width="100%">
        <tr>
            <td class="style2" colspan="2">
                <strong>Requisition Query Information</strong></td>
        </tr>
        <tr>
            <td class="style5">
                Scan Barcode:</td>
        ...
        <tr>
            ...
            <td class="style54">
                <asp:TextBox ID="TxtQueryReason" runat="server" Height="110px" 
                    TextMode="MultiLine" Width="319px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style55" colspan="2">
                <asp:Button ID="BtnProcess" runat="server" style="height: 26px" 
                    Text="Process" />
