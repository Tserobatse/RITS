<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="New_Travel.aspx.vb" Inherits="Intrack.New_Travel" %>
                        ...
                        <tr>
                            <td class="style51" valign="top">
                                ...
                                <asp:TextBox ID="txtASupVendorNo" runat="server" CssClass="style29" 
                                    height="26px" Width="128px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" 
                                    ControlToValidate="txtASupVendorNo" Display="Dynamic" ErrorMessage="Required *" 
                                    SetFocusOnError="True"></asp:RequiredFieldValidator>
                            </td>
        ...
        <table border="2" class="style6" width="1000px">
            ...
            <tr>
                <td align="center" class="style11">
                    <asp:TextBox ID="txtSuppName1" runat="server" Height="21px" 
                ...
                <td align="center" class="style78">
                    <asp:TextBox ID="txtSuppName2" runat="server" Enabled="False" Height="21px" 
                        Width="100px"></asp:TextBox>
                </td>
                <td align="center" class="style77">
                    <asp:TextBox ID="txtSuppName3" runat="server" Enabled="False" Height="21px" 
                        Width="100px"></asp:TextBox>
                </td>
                <td align="center" class="style76">
                    <asp:TextBox ID="txtSuppName4" runat="server" Enabled="False" Height="21px" 
                        Width="100px"></asp:TextBox>
                </td>
                <td align="center" class="style95">
                    <asp:TextBox ID="txtSuppName5" runat="server" Enabled="False" Height="21px" 
                        Width="100px"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style80">
                    <asp:TextBox ID="txtItemCode" runat="server" Height="21px" Width="87px"></asp:TextBox>
                </td>
                <td class="style93">
                    <asp:TextBox ID="txtServiceDesc" runat="server" Height="21px" Width="231px"></asp:TextBox>
                ...
                <td class="style92">
                    <asp:TextBox ID="txtServiceQrt" runat="server" CausesValidation="True" 
                        height="21px" MaxLength="4" Width="40px"></asp:TextBox>
                ...
                <td class="style11">
                    <asp:TextBox ID="txtsuppAmount1" runat="server" height="21px" Width="100px">0.00</asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" 
                        ControlToValidate="txtsuppAmount1" Display="Dynamic" ErrorMessage="*" 
                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                </td>
                <td class="style18">
                    <asp:TextBox ID="txtsuppAmount2" runat="server" Enabled="False" height="21px" 
                        Width="100px">0.00</asp:TextBox>
                </td>
                <td class="style23">
                    <asp:TextBox ID="txtsuppAmount3" runat="server" Enabled="False" height="21px" 
                        Width="100px">0.00</asp:TextBox>
                </td>
                <td class="style24">
                    <asp:TextBox ID="txtsuppAmount4" runat="server" Enabled="False" height="21px" 
                        Width="100px">0.00</asp:TextBox>
                </td>
                <td class="style96">
                    <asp:TextBox ID="txtsuppAmount5" runat="server" Enabled="False" height="21px" 
                        Width="100px">0.00</asp:TextBox>
                </td>
            </tr>
            <tr>
                    ...
                    <table border="2" class="style6">
                        ...
                        <tr>
                            <td class="style29" colspan="5">
                                Amount allocated:</td>
                            <td class="style50">
                                <asp:TextBox ID="txtAmountAllc" runat="server" CssClass="style52" Height="18px" 
                        ...
                        <tr>
                            ...
                            <td class="style50">
                                <asp:TextBox ID="txtAmountspent" runat="server" CssClass="style52" 
                                    height="18px" Width="75px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="style50">
                                <asp:TextBox ID="txtAmountEst" runat="server" CssClass="style52" height="18px" 
                                    Width="75px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="style86">
                                <asp:TextBox ID="txtAmountBal" runat="server" CssClass="style52" 
                                    Enabled="False" height="18px" ReadOnly="True" Width="75px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
