<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Search_Salary.aspx.vb" Inherits="Intrack.Search_Salary" %>
...
<body  class="hold-transition skin-blue-light sidebar-mini">
    ...
    <asp:RadioButtonList ID="RadioButtonList1" runat="server" BorderColor="#99CCFF" 
        ...
        <asp:ListItem Value="1">official Name</asp:ListItem>
        <asp:ListItem Value="3">Requester Name</asp:ListItem>
        <asp:ListItem Value="4">Persal No</asp:ListItem>
    </asp:RadioButtonList>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="REQ_ID" 
                ...
                DataTextField="REQ_ID" HeaderText="View" NavigateUrl="~/View_Sub_Claims_Details.aspx" 
