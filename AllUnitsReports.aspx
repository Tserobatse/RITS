<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AllUnitsReports.aspx.vb" Inherits="Intrack.AllUnitsReports" %>
  ...
  <div>
      ...
      <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtStartDate" runat="server" ToolTip="MM/DD/YYYYY" ></asp:TextBox>
         ...
         <asp:Button class="btn btn-primary" ID="btnGo" runat="server"  Text="Go" OnClick = "ExportToExcel" />

         <asp:Button class="btn btn-primary" ID="btnExport0" runat="server"  Text="Export To Excel" OnClick = "ExportToExcel" />
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        Font-Size="X-Small" BackColor="White" BorderWidth="1px">
        <Columns>
            <asp:HyperLinkField HeaderText="View" NavigateUrl="~/View_RegistryCF01Details.aspx"
                Text="View" DataNavigateUrlFormatString="View_RegistryCF01Details.aspx?REQ_ID={0}" 
                DataTextField="REQ_ID" DataNavigateUrlFields="REQ_ID" Target="_blank" />
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="spGetAllUserReport_PerUnit" SelectCommandType="StoredProcedure">
        <SelectParameters>
            ...
            <asp:FormParameter DefaultValue="01/01/2013" FormField="txtStartDate" 
