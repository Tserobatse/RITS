<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AddNewCostCentre.aspx.vb" Inherits="Intrack.AddNewCostCentre" %>
...
<form id="form1" runat="server"> 
    <table border="2" class="auto-style1" align="center">
        <tr>
            <td class="style55">
                Cheif Directorate:</td>
            <td class="style54">
                <asp:TextBox ID="txtChiefDirectorateText" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style55">
                Directorate:</td>
            <td class="style54">
                <asp:TextBox ID="txtDirectorate" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style55">
                BAS Code:</td>
            <td class="style54">
                <asp:TextBox ID="txtBASCode" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style55">
                CostCentre Code:</td>
            <td class="style54">
                <asp:TextBox ID="txtCostCentreCode" runat="server"></asp:TextBox>
            </td>
        </tr>
