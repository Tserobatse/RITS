<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="View_InternalControlRegister_Travel.aspx.vb" Inherits="Intrack.View_InternalControlRegister_Travel" %>
...
<body  class="hold-transition skin-blue-light sidebar-mini">
    ...
    <div>
        <asp:Label ID="Label2" runat="server" BackColor="White" 
            Text="Travel  :" BorderColor="#CCCCCC" Font-Bold="True" 
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" BackColor="White" 
            PostBackUrl="~/View_InternalControlRegister_Travel.aspx" Font-Bold="True" 
            Font-Italic="False" ForeColor="#666666">GO</asp:LinkButton>
    </div>
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
       ...
       PageSize="20" BackColor="White" BorderWidth="1px">
        <Columns>
            ...
            <asp:BoundField DataField="FMS Official" HeaderText="FMS_Official" 
                SortExpression="FMS Official" />
            <asp:BoundField DataField="CHECK_IN_DATE12" HeaderText="Date In" 
                SortExpression="CHECK_IN_DATE12" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="spGet_Req_Registry_Travel" 
