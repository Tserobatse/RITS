<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Scan-in-Queries-Register.aspx.vb" Inherits="Intrack.Scan_in_Queries_Register" %>
    ...
    <table class="style2" align="center" border="2">
        <tr >
            <td colspan="2" class="style7" align=center>
                <strong>Check In Query</strong></td>
        </tr>
        <tr>
            <td class="style9">
                &nbsp;</td>
