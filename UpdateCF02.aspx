<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UpdateCF02.aspx.vb" Inherits="Intrack.UpdateCF02" %>
...
<body>
    ...
    <div style="font-size: small">
        ...
        <table border="2" class="style6" width="100%">
            <tr>
                <td class="style26" colspan="3" rowspan="2" style="font-size: small">
                    &nbsp;</td>
                <td align="center" class="style87" style="font-size: small">
                    <span class="style52">SUPPLIER 1*</span></td>
                <td align="center" class="style88" style="font-size: small">
                    <span class="style52">SUPPLIER&nbsp; 2*</span></td>
                <td align="center" class="style89" style="font-size: small">
                    <span class="style52">SUPPLIER&nbsp; 3*</span></td>
                <td align="center" class="style90" style="font-size: small">
                    <span class="style52">SUPPLIER 4*</span></td>
                <td align="center" class="style94" style="font-size: small">
                    <span class="style52">SUPPLIER5*</span></td>
            </tr>
            <tr>
                <td align="center" class="style11" style="font-size: small">
                ...
                <td align="center" class="style78" style="font-size: small">
                    <asp:TextBox ID="txtSuppName2" runat="server" Height="20px" Width="100px"></asp:TextBox>
                </td>
                <td align="center" class="style77" style="font-size: small">
                    <asp:TextBox ID="txtSuppName3" runat="server" Height="20px" Width="100px"></asp:TextBox>
                </td>
                <td align="center" class="style76" style="font-size: small">
                    <asp:TextBox ID="txtSuppName4" runat="server" Height="20px" Width="100px"></asp:TextBox>
                </td>
                <td align="center" class="style95" style="font-size: small">
                    <asp:TextBox ID="txtSuppName5" runat="server" Height="20px" Width="100px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="left" class="style79" valign="top" style="font-size: small">
                    D. ITEM CODE NUMBER (ICN)</td>
                <td align="left" class="style59" valign="top" style="font-size: small">
                    DESCRIPTION OF GOODS OR SERVICE:</td>
                <td align="center" class="style58" valign="top" style="font-size: small">
                    QUANTITY</td>
                <td align="center" class="style57" valign="top" style="font-size: small">
                    R</td>
                <td align="center" class="style56" valign="top" style="font-size: small">
                    R</td>
                <td align="center" class="style55" valign="top" style="font-size: small">
                    R</td>
                <td align="center" class="style54" valign="top" style="font-size: small">
                    R</td>
                <td align="center" class="style96" valign="top" style="font-size: small">
                    R</td>
            </tr>
            <tr>
                ...
                <td class="style93" style="font-size: small">
                ...
                <td class="style92" style="font-size: small">
                ...
                <td class="style24" style="font-size: small">
            ...
            <tr>
                <td align="right" class="style26" colspan="3" style="font-size: small">
                    TOTAL AMOUNT:</td>
                <td class="style11" style="font-size: small">
                    &nbsp;</td>
                <td class="style18" style="font-size: small">
        ...
        <table border="2" class="style6" width="100%" style="font-size: small">
            <tr>
                <td class="style3" style="font-size: small">
                    &nbsp;</td>
                <td class="style62" colspan="2" style="font-size: small">
                    I<strong>. CHECKED BY:</strong></td>
                <td class="style61" style="font-size: small">
                    K. APPROVED /NOT APPROVED</td>
            </tr>
            <tr>
                <td class="style3" valign="top" style="font-size: small">
                    <table border="2" cla ss="style6" width="100%">
                        <tr>
                            <td class="style68">
                                E. Dept No.</td>
                            <td class="style97">
                        ...
                        <tr>
                            ...
                            <td class="style50">
                                ...
                                <asp:RangeValidator ID="RangeValidator1" runat="server" 
                                    ControlToValidate="txtAmountAllc" Display="Dynamic" ErrorMessage="*" 
                                    MaximumValue="100000000" MinimumValue="1" SetFocusOnError="True" 
                ...
                <td class="style47" colspan="2" valign="top" style="font-size: small">
           ...
           <tr>
            ...
            <td class="style2" valign="top" style="font-size: small" bgcolor="#FFFFCC">
